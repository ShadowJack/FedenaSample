...
ActiveRecord::Schema.define(:version => 20120816045034) do
  ...
  add_index "assessment_scores", ["student_id", "batch_id", "descriptive_indicator_id", "exam_id"], :name => "score_index", :limit => {"batch_id"=>nil, "descriptive_indicator_id"=>nil, "student_id"=>nil, "exam_id"=>nil}
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"batch_id"=>nil, "student_id"=>nil, "observable_id"=>nil, "exam_id"=>nil, "observable_type"=>nil}
